...
def send_transaction(w3, account, to, wage):
    ...
    raw_tx = {
        ...
        "value": value,
        "gas": gasEstimate,
        "gasPrice": 875000000, # According to a new addition to Ganache this value can no longer be 0 and has to be a minimum of 875000000, see References and Resources section on README.md file for details
